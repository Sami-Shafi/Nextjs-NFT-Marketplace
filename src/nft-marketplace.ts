...
export function handleItemBought(event: ItemBoughtEvent): void {
	...
	// don't mention the price here. That way it will set to 0
...
export function handleItemCancelled(event: ItemCancelledEvent): void {
	...
	// buyer is deadString. Not 0. It will be regarded as item cancellation.
...
export function handleItemListed(event: ItemListedEvent): void {
    ...
    // we don't need buyer but activeItem expects one
